...
class SeleniumDriver:
    ...
    def waitForElement(self, locator, locator_type="id", timeoutSecs=10, poll_freq=1):
        element = None
    ...
    def select_dropdown_value(self, dropdown_value, dropdown_locator, dropdown_locator_type="id"):
